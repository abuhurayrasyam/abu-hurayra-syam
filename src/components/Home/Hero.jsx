    ...
    return (
        <div className="flex flex-col-reverse md:flex-row w-11/12 mx-auto">
            <section className="w-full md:w-1/2 md:pt-[100px] space-y-4">
                ...
                <p className="text-primary font-extrabold">Junior MERN Stack Developer</p>
                <p className='text-neutral'>I’m a passionate Full Stack Web Developer specialized in the MERN Stack. My core strength is building secure, scalable, and efficient web applications.</p>
                ...
                <a href="/Abu-Hurayra-Syam-Resume.pdf" download="Abu-Hurayra-Syam-Resume.pdf">
